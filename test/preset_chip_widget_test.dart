...
void main() {
  ...
  group('PresetChipWidget Tests', () {
    testWidgets('renders with name in uppercase', (WidgetTester tester) async {
      ...
      final choiceChip = tester.widget<InputChip>(chipFinder);
      expect(choiceChip.selected, isFalse);
    });

    testWidgets('displays as selected when isSelected is true', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('invokes onSelected callback when enabled and tapped', (
      WidgetTester tester,
    ) async {
      bool? selectedValue;
      await tester.pumpWidget(
    ...
    testWidgets('does not invoke onSelected when isEnabled is false', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('invokes delete callback when delete affordance is tapped', (
      WidgetTester tester,
    ) async {
      var deleteCount = 0;
      await tester.pumpWidget(
