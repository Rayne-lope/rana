...
void main() {
  ...
  group('CompactStyleStripWidget Tests', () {
    testWidgets(
      'renders nothing (SizedBox.shrink) when activePreset is null',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
              body: CompactStyleStripWidget(activePreset: null),
            ),
          ),
        );
    ...
    testWidgets(
      'renders default zeros when activePreset style block is null',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      'renders correct rounding behavior for edge values',
      (WidgetTester tester) async {
        const styledPreset = PresetModel(
          id: 'test_preset',
          name: 'Test Preset',
