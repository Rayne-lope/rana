  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: ConstrainedBox(
        ...
        child: CustomPaint(
          painter: _StylesPanelBackgroundPainter(),
          child: DecoratedBox(
...
class _StylesPanelBackgroundPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final rect = Offset.zero & size;
    final rrect = RRect.fromRectAndRadius(
  ...
  @override
  bool shouldRepaint(covariant _StylesPanelBackgroundPainter oldDelegate) =>
      false;
}
